 ...
 * @author Acer
 */
public class Psicologoa {
    private String nombre;
    private String correo;
    private String tutor;

    public Psicologoa(String nombre, String correo, String tutor) {
        this.nombre = nombre;
        this.correo = correo;
        this.tutor = tutor;
    }
    ...
    public static boolean Validartutor(String tutor){
        boolean existe=false;
        Basedcon cn = new Basedcon();
        ResultSet rs = cn.Seleccionartutores();
        try{
            while(rs.next()){
                if(rs.getString("nombre").equals(tutor)){
                    existe=true;
                    //System.out.println(rs.getInt("indice"));
                    break;
                }
    ...
    public static boolean Validarinfo(String nombre, String correo, String tutor){
        boolean error=false;
        ...
        }if ((tutor.isBlank() || tutor.isEmpty()) && !error){
            JOptionPane.showMessageDialog(null, "No has ingresado nada en el campo Tutor");
            error=true;
        }else if (!(tutor.isBlank() || tutor.isEmpty()) && !error){
            error=false;
        }
        return !error;
    }
